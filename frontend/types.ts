...
export const CUSTOM_STATUS_NAMES: Record<TaskStatus, { name: string; tooltip: string }> = {
  [TaskStatus.WAITING_FOR_REQUIREMENT]: { name: 'New Task', tooltip: 'New / Ready' },
  [TaskStatus.TODO]: { name: 'started', tooltip: 'Assigned / To Do' },
  [TaskStatus.IN_PROGRESS]: { name: 'In Progress', tooltip: 'In Progress' },
  [TaskStatus.BLOCKED]: { name: 'Half Done', tooltip: 'Blocked / Critical' },
  [TaskStatus.IN_REVIEW]: { name: 'Almost Done', tooltip: 'Manager Review / QA' },
  [TaskStatus.ON_HOLD]: { name: 'On Hold', tooltip: 'Paused / Waiting' },
  [TaskStatus.DONE]: { name: 'Completed', tooltip: 'Done / Complete - level rewards' },
  [TaskStatus.FAILED]: { name: 'Failed', tooltip: 'Mission Failed - Couldn\'t complete' },
  [TaskStatus.GRAVEYARD]: { name: 'Archived', tooltip: 'for tasks no longer active' },
};
