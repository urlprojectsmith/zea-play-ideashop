...
const featureChecklist = [
    {
        ...
        description: 'Check and manage your assignments and priorities.'
    },
    {
        icon: <RocketLaunchIcon className="h-4 w-4" />,
        title: 'Work with your team',
        description: 'Collaborate smoothly with colleagues and partners.'
    },
    {
        icon: <TrophyIcon className="h-4 w-4" />,
        title: 'Track your progress',
        description: 'Monitor performance, goals, and key results.'
    }
];
...
const Login: React.FC = () => {
    ...
    const formSubtitleClass = isDark ? 'text-white/70' : 'text-black';
        ...
        >
            ...
            */}
            ...
            <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-10">
                <div className="grid w-full max-w-md gap-10 px-4 py-4 lg:rounded-3xl lg:border lg:border-white/10 lg:bg-white/5 lg:shadow-[0_20px_70px_rgba(15,23,42,0.45)] lg:backdrop-blur-2xl lg:max-w-6xl lg:grid-cols-[1.15fr,0.85fr] lg:px-8 lg:py-10" style={{ animation: 'cardFloat 11s ease-in-out infinite' }}>
                    <div className="hidden flex-col justify-between gap-8 lg:flex">
                        <div>
                            ...
                            <p className={`mt-3 max-w-xl text-sm ${heroBodyClass}`}>
                                Sign in to access your dashboard, manage tasks, and stay connected with your team.
                            </p>
                        </div>
                    ...
                    <div className={`relative overflow-hidden rounded-3xl border px-5 py-5 shadow-[0_25px_55px_rgba(15,23,42,0.35)] backdrop-blur-xl lg:px-8 lg:py-10 ${cardSurface}`}>
                        ...
                        <img src={HERO_ART} alt="Workspace overview" className="pointer-events-none absolute -right-10 top-24 hidden h-56 w-72 opacity-70 md:block" />
                        ...
                        <div className="relative space-y-8">
                            ...
                            <p className={`text-center text-xs ${tipTextClass}`}>
                                Tip: Daily streak rewards reset at midnight. Don’t miss out!
                            </p>
                        </div>
                    </div>
                </div>
