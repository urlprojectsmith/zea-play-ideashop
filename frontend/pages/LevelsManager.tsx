...
const LevelsManager: React.FC = () => {
    ...
    const badgeStateClass = (state: BadgeState) => {
        if (state === 'active') {
            return 'border-emerald-300/40 bg-emerald-500/15 text-emerald-700';
        }
        if (state === 'archived') {
            return 'border-rose-300/40 bg-rose-500/15 text-rose-700';
        }
        return 'border-amber-300/40 bg-amber-500/15 text-amber-700';
    };
    ...
    return (
        <div className="space-y-8 rounded-3xl bg-slate-50/70 p-4 sm:p-6">
            <style>{`
            ...
            <header className="flex flex-wrap items-start justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    {canEditLevels && (
                        <>
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-2 rounded-full border border-amber-300/60 bg-amber-400/10 px-4 py-2 text-sm font-semibold text-amber-700 transition hover:bg-amber-400/20"
                            >
                                Reset Map
                            </button>
                        </>
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-full border border-sky-300/50 bg-sky-400/10 px-4 py-2 text-sm font-semibold text-sky-700 transition hover:bg-sky-400/20"
                    >
            ...
            {clipboardNotice && (
                <div className="rounded-2xl border border-emerald-400/40 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-700">
                    {clipboardNotice}
                </div>
            )}
            ...
            <section className="grid items-start gap-6 xl:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
                <div className="space-y-6">
                    <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-50 p-6 shadow-sm">
                        <div
                            className="pointer-events-none absolute inset-0 opacity-50"
                            style={{
                                backgroundImage:
                                    'radial-gradient(circle at 20% 20%, rgba(148,163,184,0.18), transparent 40%), radial-gradient(circle at 80% 30%, rgba(56,189,248,0.12), transparent 45%), radial-gradient(circle at 30% 80%, rgba(99,102,241,0.10), transparent 45%)',
                            }}
                        />
                        <div className="relative">
                            <div className="mb-4 flex flex-wrap items-center justify-between gap-3 text-xs uppercase tracking-[0.35em] text-slate-600">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div
                                                ...
                                                } text-slate-900 shadow-[0_10px_30px_rgba(15,23,42,0.6)] ${
                                            ...
                                            <div className="mt-3">
                                                ...
                                                <p className="text-xs text-slate-600">{level.pointsRequired.toLocaleString()} XP</p>
                                            </div>
                                            {hasReward && (
                                                <div className="mt-2 inline-flex items-center gap-1 rounded-full border border-emerald-300/50 bg-emerald-500/10 px-2 py-1 text-[10px] uppercase tracking-[0.25em] text-emerald-700">
                                            ...
                                            {usersAtLevel.length > 0 && (
                                                <div className="mt-3 flex items-center gap-2">
                                                    <div className="flex -space-x-2">
                                                        {usersAtLevel.slice(0, 3).map((user) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={user.id}
                                                                    className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-100 bg-slate-200 text-xs font-semibold text-slate-900"
                                                                >
                                                                    {avatar ? (
                                                    ...
                                                    {usersAtLevel.length > 3 && (
                                                        <span className="text-xs text-slate-600">+{usersAtLevel.length - 3}</span>
                                                    )}
                                                </div>
                                            )}
                                        </button>
                ...
                <aside className="space-y-5">
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Your Level</p>
                                <p className="mt-2 text-3xl font-bold text-slate-900">Lv {currentUserProgress.level}</p>
                            </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-5">
                        <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Next Reward</p>
                    ...
                    {selectedLevel && (
                        <div className="rounded-2xl border border-slate-200 bg-white p-5">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Selected Level</p>
                                    <p className="mt-2 text-lg font-semibold text-slate-900">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 rounded-full border border-slate-300 px-3 py-1 text-xs text-slate-700 transition hover:border-slate-400"
                                >
                            ...
                            {selectedLevel.reward?.title && (
                                <div className="mt-3 rounded-xl border border-emerald-300/40 bg-emerald-400/10 p-3 text-xs text-emerald-700">
                    ...
                    {canEditLevels && selectedLevel && draftLevel && (
                        <div className="rounded-2xl border border-slate-200 bg-white p-5">
                            <div className="flex items-center justify-between">
                                <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Edit Level</p>
                            ...
                            <div className="mt-4 space-y-4 text-sm text-slate-700">
                                <label className="block">
                                    ...
                                    <input
                                        ...
                                        className="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-slate-900 focus:border-amber-300 focus:outline-none"
                                    />
                                </label>
                                <label className="block">
                                    <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Points Required</span>
                                    <input
                                        type="number"
                                ...
                                <label className="block">
                                    <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Reward Library</span>
                                    <select
                                ...
                                <label className="block">
                                    <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Reward Title</span>
                                    <input
                                ...
                                <label className="block">
                                    <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Reward Description</span>
                                    <textarea
                                        rows={3}
                            ...
                            <div className="mt-5 flex flex-wrap items-center gap-3">
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 rounded-full border border-emerald-300/50 bg-emerald-500/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-emerald-700 transition hover:bg-emerald-500/30"
                                >
                                    Save Level
                                </button>
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 rounded-full border border-rose-300/50 bg-rose-500/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-rose-700 transition hover:bg-rose-500/30 disabled:opacity-40"
                                >
            ...
            <section className="grid gap-6 lg:grid-cols-[1.2fr,1fr]">
                <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-50 p-6">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            <p className="text-xs uppercase tracking-[0.35em] text-slate-600">Badge studio</p>
                            <h2 className="mt-2 text-2xl font-bold text-slate-900">{badgeModeLabel}</h2>
                            <p className="mt-2 text-sm text-slate-600">
                                Define badge metadata, tier sequencing, artwork, and advanced rules.
                            </p>
                        </div>
                        <div className="flex flex-col items-end gap-2">
                            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-100 text-amber-700">
                            ...
                            {selectedBadge && (
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    {selectedBadge.isSystem && (
                                        <span className="rounded-full border border-slate-200 bg-white px-2 py-1 text-[10px] uppercase tracking-[0.25em] text-slate-700">
                                            System
                                        </span>
                                    )}
                                </div>
                    ...
                    <div className="mt-5 grid gap-4 text-sm text-slate-700">
                        <label className="block">
                            <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Badge name</span>
                            <input
                                ...
                                className="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-slate-900 focus:border-amber-300 focus:outline-none disabled:opacity-70"
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <label className="block">
                                <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Bonus XP</span>
                                <input
                                    type="number"
                                    min={0}
                        ...
                        <div className="grid gap-4 md:grid-cols-3">
                            <label className="block">
                                <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Tier</span>
                                <input
                            ...
                            <label className="block">
                                <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Tier group</span>
                                <input
                            ...
                            <label className="block">
                                <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Tier order</span>
                                <input
                                    type="number"
                                    min={1}
                    ...
                    <div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                <p className="text-xs uppercase tracking-[0.3em] text-slate-600">Badge artwork</p>
                                <p className="mt-2 text-sm text-slate-600">Upload a PNG or drop a hosted URL.</p>
                            </div>
                            <span className="text-xs text-slate-500">Saved on publish</span>
                        </div>
                        <div className="mt-4 grid gap-3 text-sm text-slate-700">
                            <label className="block">
                                <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Image URL</span>
                                <input
                                    type="url"
                            ...
                            <label className="block">
                                <span className="text-xs uppercase tracking-[0.2em] text-slate-500">Upload image</span>
                                <input
                                    type="file"
                                    accept="image/png,image/svg+xml,image/*"
                                    onChange={handleBadgeImageUpload}
                                    disabled={!canEditBadges}
                                    className="mt-2 w-full cursor-pointer rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-700 file:mr-4 file:rounded-full file:border-0 file:bg-slate-200 file:px-3 file:py-1 file:text-xs file:font-semibold file:text-slate-700 disabled:opacity-70"
                                />
                            </label>
                            {badgePreview && (
                    ...
                    <div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
                        <div className="flex flex-wrap items-start justify-between gap-3">
                            <div>
                                <p className="text-xs uppercase tracking-[0.3em] text-slate-600">Advanced rule builder</p>
                                <p className="mt-2 text-sm text-slate-600">
                            ...
                            <label className="text-xs uppercase tracking-[0.2em] text-slate-500">
                                ...
                                <select
                                    ...
                                    disabled={!canEditBadges}
                                    className="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-900 focus:border-amber-300 focus:outline-none disabled:opacity-70"
                                >
                        ...
                        <div className="mt-4 space-y-4">
                            {badgeDraft.rules.rules.map((rule, index) => {
                                ...
                                return (
                                    <div key={`${rule.entity}-${rule.event}-${index}`} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                        <div className="flex items-center justify-between">
                                            <p className="text-xs uppercase tracking-[0.3em] text-slate-600">Rule {index + 1}</p>
                                            {badgeDraft.rules.rules.length > 1 && (
                                                <button
                                                    type="button"
                                                    onClick={() => handleRuleRemove(index)}
                                                    disabled={!canEditBadges}
                                                    className="text-xs uppercase tracking-[0.2em] text-rose-700/80 transition hover:text-rose-700 disabled:opacity-50"
                                                >
                                                    Remove
                                                </button>
                                            )}
                                        ...
                                        <div className="mt-3 grid gap-3 md:grid-cols-3">
                                            <label className="block">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500">Entity</span>
                                                <select
                                                    value={rule.entity}
                                                    onChange={(event) =>
                                            ...
                                            <label className="block">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500">Event</span>
                                                <select
                                                    value={rule.event}
                                                    onChange={(event) =>
                                            ...
                                            <label className="block">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500">Count</span>
                                                <div className="mt-2 flex gap-2">
                                                    <select
                                                        ...
                                                        disabled={!canEditBadges}
                                                        className="w-20 rounded-xl border border-slate-200 bg-slate-50 px-2 py-2 text-sm text-slate-900 focus:border-amber-300 focus:outline-none disabled:opacity-70"
                                                    >
                                                    ...
                                                    <input
                                                        ...
                                                        disabled={!canEditBadges}
                                                        className="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-900 focus:border-amber-300 focus:outline-none disabled:opacity-70"
                                                    />
                                                </div>
                                            </label>
                                        </div>
                                        <div className="mt-3 grid gap-3 md:grid-cols-2">
                                            <label className="block">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500">Assigned to</span>
                                                <select
                                            ...
                                            <label className="block">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500">Created by</span>
                                                <select
                                        ...
                                        <div className="mt-3 grid gap-3 md:grid-cols-2">
                                            <label className="block">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500">Project ID</span>
                                                <input
                                            ...
                                            <label className="block">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500">Pipeline ID</span>
                                                <input
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <div className="mt-2 flex flex-wrap gap-2">
                                                {BADGE_PRIORITY_OPTIONS.map((priority) => {
                                                    ...
                                                    return (
                                                        <label key={priority} className="inline-flex items-center gap-2 text-xs text-slate-600">
                                                            <input
                                                                type="checkbox"
                                                                checked={isChecked}
                                                                onChange={() => {
                                                                ...
                                                                disabled={!canEditBadges}
                                                                className="h-4 w-4 rounded border-slate-300 bg-slate-100 text-amber-300 focus:ring-amber-300 disabled:opacity-50"
                                                            />
                                                            {priority}
                                                        </label>
                                                    );
                                        ...
                                        <div className="mt-3 flex flex-wrap items-center gap-4 text-xs text-slate-600">
                                            ...
                                            {hasTimeWindow && (
                                                <div className="flex items-center gap-2">
                                                    <input
                                                        ...
                                                        disabled={!canEditBadges}
                                                        className="w-20 rounded-xl border border-slate-200 bg-slate-50 px-2 py-1 text-xs text-slate-900 focus:border-amber-300 focus:outline-none disabled:opacity-70"
                                                    />
                                                    <select
                                                        ...
                                                        disabled={!canEditBadges}
                                                        className="rounded-xl border border-slate-200 bg-slate-50 px-2 py-1 text-xs text-slate-900 focus:border-amber-300 focus:outline-none disabled:opacity-70"
                                                    >
                                            ...
                                            <label className="inline-flex items-center gap-2">
                                                <input
                                                    ...
                                                    disabled={!canEditBadges}
                                                    className="h-4 w-4 rounded border-slate-300 bg-slate-100 text-rose-300 focus:ring-rose-300 disabled:opacity-50"
                                                />
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-3">
                            <button
                                ...
                                disabled={!canEditBadges}
                                className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-3 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-slate-700 transition hover:border-slate-300 hover:bg-slate-100 disabled:opacity-40"
                            >
                                <PlusIcon className="h-3 w-3" />
                                Add rule
                            </button>
                            <span className="text-xs text-slate-500">Rules are evaluated in real time.</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-5 flex flex-wrap items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-full border border-emerald-300/50 bg-emerald-500/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-emerald-700 transition hover:bg-emerald-500/30 disabled:opacity-40"
                        >
                        ...
                        {selectedBadge && canEditBadges && (
                            <button
                                ...
                                className="inline-flex items-center gap-2 rounded-full border border-rose-300/50 bg-rose-500/15 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-rose-700 transition hover:bg-rose-500/25"
                            >
                                <TrashIcon className="h-4 w-4" />
                                Delete badge
                            </button>
                        ...
                        {!canEditBadges && (
                            <span className="text-xs text-slate-500">Managers can view badges but cannot modify them.</span>
                        )}
                    </div>
                </div>
                ...
                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                            <p className="text-xs uppercase tracking-[0.35em] text-slate-600">Badge list</p>
                            <p className="mt-2 text-sm text-slate-600">{sortedBadges.length} total</p>
                        </div>
                        {canEditBadges && (
                            <button
                                type="button"
                    ...
                    {sortedBadges.length === 0 ? (
                        <p className="mt-4 text-sm text-slate-600">No badges yet. Create one to start the deck.</p>
                    ) : (
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="h-12 w-12 overflow-hidden rounded-xl bg-slate-100">
                                                {badge.imageUrl ? (
                                                    ...
                                                    <div className="flex h-full w-full items-center justify-center text-[10px] text-slate-500">No art</div>
                                                )}
                                            </div>
                                            <div>
                                                <p className="text-sm font-semibold text-slate-900">{badge.name}</p>
                                                <p className="text-xs text-slate-600">{badge.description}</p>
                                                <p className="mt-1 text-[10px] uppercase tracking-[0.25em] text-amber-700">
                                                    +{badge.bonusXp} XP
                                                </p>
                                            </div>
                                        </div>
                                        <div className="flex flex-wrap items-center gap-2 text-[10px] uppercase tracking-[0.25em] text-slate-600">
                                            <span className={`rounded-full border px-2 py-1 ${badgeStateClass(badge.state)}`}>{badge.state}</span>
                                            <span className="rounded-full border border-slate-200 bg-white px-2 py-1">{badge.tier}</span>
                                            {badge.tierGroup && (
                                            ...
                                            {badge.isSystem && (
                                                <span className="rounded-full border border-slate-200 bg-white px-2 py-1">System</span>
                                            )}
                                        </div>
                                    </button>
                                );
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/35 px-4 py-8">
                    ...
                    <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
                        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 px-6 py-4">
                            <div>
                                <p className="text-xs uppercase tracking-[0.35em] text-slate-500">Level Roster</p>
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className={`rounded-full border px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] transition ${
                                        levelUsersView === 'grid'
                                            ? 'border-sky-300/60 bg-sky-400/20 text-sky-700'
                                ...
                                <button
                                    ...
                                    className={`rounded-full border px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] transition ${
                                        levelUsersView === 'list'
                                            ? 'border-amber-300/60 bg-amber-400/20 text-amber-700'
                                            : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300'
                                    }`}
                                >
                                    List
                                ...
                                <button
                                    type="button"
                                    onClick={() => setLevelUsersOpen(false)}
                                    className="rounded-full border border-slate-300 bg-white px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-slate-700 transition hover:border-slate-300"
                                >
                                    Close
                                </button>
                            </div>
                                ...
                                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                    {selectedLevelUsers.map((user) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div className="h-12 w-12 overflow-hidden rounded-full border border-slate-300 bg-slate-200">
                                                        {avatar ? (
                                ...
                                <div className="space-y-3">
                                    {selectedLevelUsers.map((user) => {
                                        ...
                                        return (
                                            <div
                                                key={user.id}
                                                className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900"
                                            >
                                                <div className="flex items-center gap-3">
