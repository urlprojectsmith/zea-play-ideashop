      ...
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-gray-700 hover:bg-gray-100"
          >
            Create Task
          </button>
        )}
