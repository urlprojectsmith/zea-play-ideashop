...
const Sidebar: React.FC<SidebarProps> = ({ onSupportClick, isCollapsed, onToggleCollapse, onVersionClick, versionLabel }) => {
    ...
    const adminLinks: SidebarLink[] = [
        ...
        },
        {
            ...
            icon: (
                <img
                    src="https://res.cloudinary.com/dqhcbck76/image/upload/v1770241421/Manage_rewards_p1fzva.png"
                    alt="Manage Staff Performance"
                    className="h-6 w-6 object-contain"
                />
            ),
    ...
    const getNavLinks = () => {
        ...
        links.push({
            ...
            icon: (
                <img
                    src="https://res.cloudinary.com/dqhcbck76/image/upload/v1770241421/level-up_l6lcwq.png"
                    alt="Staff Levels"
                    className="h-6 w-6 object-contain"
                />
            ),
        ...
        if (user?.role === Role.OWNER) {
            links.push({
                ...
                icon: (
                    <img
                        src="https://res.cloudinary.com/dqhcbck76/image/upload/v1770241423/points_jgi3yh.png"
            ...
            links.push({
                ...
                icon: (
                    <img
                        src="https://res.cloudinary.com/dqhcbck76/image/upload/v1770241423/layout_xgg1fa.png"
                        alt="Medical Templates"
                        className="h-6 w-6 object-contain"
                    />
                ),
                label: 'Medical Templates',
            });
            */
            links.push({
                to: '/api/overview',
    ...
    const navLinkClass = ({ isActive }: { isActive: boolean }) =>
        `sidebar-link flex items-center ${isCollapsed ? 'justify-center px-2' : 'space-x-3 px-4'} py-3 rounded-lg transition-all duration-300 ease-in-out ${isActive
                ...
                <div className="px-4 pb-2 pt-2">
                    <div className="flex items-center justify-center">
                        <button
                            ...
                            className="hidden theme-pill-button group flex items-center gap-2 rounded-full border border-cyan-200/40 bg-slate-950/70 px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.28em] text-cyan-100 shadow-[0_0_14px_rgba(34,211,238,0.35)] transition hover:border-cyan-200/70 hover:text-white"
