...
def _apply_user_updates(db: Session, user: models.User, payload: schemas.UserUpdate) -> None:
    ...
    if "browser_notifications_enabled" in payload.model_fields_set:
        user.browser_notifications_enabled = bool(payload.browser_notifications_enabled)
    ...
    if "browser_notifications_enabled" in payload.model_fields_set:
        user.browser_notifications_enabled = bool(payload.browser_notifications_enabled)
    if "is_present" in payload.model_fields_set:
        user.is_present = payload.is_present
...
def create_user(
    ...
    user = models.User(
        ...
        browser_notifications_enabled=bool(payload.browser_notifications_enabled),
